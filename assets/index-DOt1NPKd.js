...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ii,depthTest:!1,depthWrite:!1})}function wd(){return new Ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Su(),fragmentShader:`
		...
		`,blending:Ii,depthTest:!1,depthWrite:!1})}function Rd(){return new Ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Su(),fragmentShader:`
